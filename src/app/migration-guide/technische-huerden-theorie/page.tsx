          ...
          <div key={chapter} className="mb-4">
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-2 text-lg font-bold ${
                expandedChapter === chapter ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-100'
              } rounded-md`}
            >
              Kapitel 6.{chapter}
              <span
                className={`transform transition-transform ${
                  expandedChapter === chapter ? 'rotate-90' : ''
                }`}
              >
                ▶
              </span>
            ...
            {expandedChapter === chapter && (
              <div className="mt-2 space-y-1">
                {huerden
                  .filter((huerde) => huerde.chapter === chapter)
                  .map((huerde) => (
                    <button
                      key={huerde.id}
